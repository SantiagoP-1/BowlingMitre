...
export function WhatsAppFloatingButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-brand-red text-white shadow-[0_10px_28px_-8px_rgba(227,28,35,0.8)] transition hover:brightness-110 sm:bottom-7 sm:right-7"
    >
