  ...
  return (
    <footer className="border-t border-line-soft py-12">
      <Container className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="font-display text-lg font-extrabold">BOWLING MITRE</p>
        ...
        <div className="flex flex-col gap-3 font-mono text-xs uppercase tracking-wide text-ink-dim">
          <a
      ...
      <Container className="mt-10 border-t border-line-soft pt-6">
        <p className="font-mono text-[11px] uppercase tracking-wide text-ink-faint">
          © {new Date().getFullYear()} Bowling Mitre
        </p>
      </Container>
    </footer>
  );
